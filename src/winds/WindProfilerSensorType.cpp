...
//std::cout << "sensors[i]->site_xcoord " << WID->metParams->sensors[i]->site_xcoord << std::endl;
//std::cout << "sensors[i]->site_ycoord " << WID->metParams->sensors[i]->site_ycoord << std::endl;
//std::cout << "WGD->dx " << WGD->dx << std::endl;
//std::cout << "WGD->dy " << WGD->dy << std::endl;
//std::cout << "WGD->nx " << WGD->nx << std::endl;
//std::cout << "site_i[idx] " << site_i[idx] << std::endl;
//std::cout << "site_j[idx] " << site_j[idx] << std::endl;
//std::cout << "site_id[idx] " << site_id[idx] << std::endl;
///std::cout << "WGD->terrain_face_id[site_id[idx]] " << WGD->terrain_face_id[site_id[idx]] << std::endl;
   for (int i = 0; i < 10; ++i) {
        std::cout << "WGD->z_face[" << i << "] = " << WGD->z_face[i] << std::endl;
    }
...
//std::cout << "z_terrain:"  << z_terrain << std::endl;
    ...
    if (ts->site_z_ref[0] > 0) {
      ...
      if (ts->site_blayer_flag == 4) {
       ...
       ts->site_z_ref[0]=ts->site_z_ref[0];
...
//	u_prof[idx * WGD->nz + k] = (cos(site_theta[idx]) * u_star / vk) * (log(((WGD->z[k] - z_terrain)) / ts->site_z0) + psi);
  //      v_prof[idx * WGD->nz + k] = (sin(site_theta[idx]) * u_star / vk) * (log(((WGD->z[k] - z_terrain)) / ts->site_z0) + psi);

      }
//std::cout << "site_U_ref[0]: " << ts->site_U_ref[0] << std::endl;
//std::cout << "u_star: " << u_star << std::endl;
//std::cout << "site_z_ref[0]: " << ts->site_z_ref[0] << std::endl;
